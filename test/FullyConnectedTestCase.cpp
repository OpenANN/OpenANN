...
void FullyConnectedTestCase::parallelForward()
{
  ...
  ASSERT_EQUALS_DELTA((*y)(1, 0), tanh(3.5), 1e-10);
  ASSERT_EQUALS_DELTA((*y)(1, 1), tanh(3.5), 1e-10);
  ...
  ASSERT_EQUALS_DELTA(Wd(3), 2.0*0.5*(1.0-(*y)(0, 1)*(*y)(0, 1))*2.0, 1e-7);
  ASSERT_EQUALS_DELTA(Wd(4), 2.0*1.0*(1.0-(*y)(0, 1)*(*y)(0, 1))*2.0, 1e-7);
  ASSERT_EQUALS_DELTA(Wd(5), 2.0*2.0*(1.0-(*y)(0, 1)*(*y)(0, 1))*2.0, 1e-7);
  ASSERT(e2 != 0);
}
